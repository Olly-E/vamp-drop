...
export default function Home() {
  ...
  return (
    <section
      className="h-[calc(100%-45px)] text-white w-full relative"
      style={{ backgroundImage: "var(--color-vamp-gradient)" }}
    >
      <div className="max-w-[1141px] mx-auto pt-16">
        <div className="flex flex-col px-4 xs:px-[30px] xl:px-0 lg:gap-10 lg:flex-row items-start justify-between w-full">
          <div className="lg:w-[527px]">
            ...
            <p className="text-[20px] sm:text-[24px] text-primary font-[500] mt-6 w-[500px] xl:w-[527px]">
        ...
        <div className=" grid grid-cols-3 items-stretch gap-4 -mt-10">
          {PERKS_DATA?.map((card) => (
