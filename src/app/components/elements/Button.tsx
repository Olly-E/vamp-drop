...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <Tag
      ...
      className={clsx(
        className,
        "rounded-[3px] justify-center font-medium whitespace-nowrap w-fit focus:outline-blue-state disabled:cursor-not-allowed gap-2 disabled:opacity-70 h-[40px] cursor-pointer flex items-center transition-colors duration-100",
